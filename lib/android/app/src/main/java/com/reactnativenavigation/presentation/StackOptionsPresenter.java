...
public class StackOptionsPresenter {
    ...
    public void mergeChildOptions(Options options, Options resolvedOptions, Component child) {
        ...
        mergeButtons(withDefault.topBar.buttons, resolvedOptions.topBar.copy().mergeWithDefault(defaultOptions.topBar), withDefault.topBar.rightButtonColor, withDefault.topBar.leftButtonColor);
